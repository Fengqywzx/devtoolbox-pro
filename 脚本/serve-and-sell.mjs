...
const root = path.resolve(import.meta.url.replace('/脚本/serve-and-sell.mjs','').replace('file:///',''));
...
// Product metadata
const PRODUCTS = [
  { id: 'devtoolbox', name: 'DevToolbox Pro 程序员工具箱', file: '开发工具箱.html', price: '¥9.9', icon: '🛠', desc: 'JSON格式化/Base64/正则/时间戳/UUID/颜色工具 八合一' },
  { id: 'resume', name: '极简简历模板', file: '产品/简历模板-极简风格.html', price: '¥5.9', icon: '📄', desc: 'A4纸直接打印，浏览器打开可编辑，适合找实习/秋招' },
  { id: 'planner', name: '考前冲刺计划器', file: '产品/学习计划器-StudyPlanner.html', price: '¥5.9', icon: '📚', desc: '番茄钟+任务管理+艾宾浩斯复习提醒，期末必备' },
  { id: 'algo', name: '面试算法速查卡', file: '产品/面试算法速查卡.html', price: '¥5.9', icon: '⚡', desc: '20+核心算法模板，排序/DP/图论/系统设计，面试前速查' },
];
...
const server = http.createServer((req, res) => {
  ...
  // Serve static files
  let filePath = url.pathname === '/' ? '/产品/产品展示页.html' : url.pathname;
