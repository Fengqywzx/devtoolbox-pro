...
fs.writeFileSync(path.join(root, '.gitignore'), [
  ...
  'backups/', '.buddy/', '脚本/think-daemon.mjs', '笔记/',
  'orders.log', '.git'
].join('\n'));
...
const packages = [
  { name: 'DevToolbox-Pro', files: ['开发工具箱.html'] },
  { name: '简历模板-极简风格', files: ['产品/简历模板-极简风格.html'] },
  { name: '考前冲刺计划器', files: ['产品/学习计划器-StudyPlanner.html'] },
  { name: '面试算法速查卡', files: ['产品/面试算法速查卡.html'] },
];
...
console.log('\n🌐 生成分享页面...');
console.log('   ✅ 产品展示页: 产品/产品展示页.html');
...
console.log('');
console.log('  📋 文件清单:');
console.log('     开发工具箱.html — 程序员工具箱');
console.log('     产品/简历模板-极简风格.html');
console.log('     产品/学习计划器-StudyPlanner.html');
console.log('     产品/面试算法速查卡.html');
console.log('     产品/产品展示页.html — 发给买家看');
console.log('     产品/朋友圈文案+社群推广语.txt');
console.log('     产品/screenshots/ — 4张产品截图');
console.log('');
...
console.log('');
console.log('  💰 开始销售:');
console.log('     1. 发朋友圈 → 复制 产品/朋友圈文案+社群推广语.txt');
console.log('     2. 闲鱼发布 → 复制 产品/销售执行方案.md');
console.log('     3. 班级群 → 发产品展示页链接');
console.log('     4. 收钱 → 微信红包/支付宝');
console.log('');
console.log('  📱 或启动本地销售服务器:');
console.log('     node 脚本/serve-and-sell.mjs');
