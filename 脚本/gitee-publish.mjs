...
async function main() {
  ...
  if (!fs.existsSync(indexPath)) {
    fs.writeFileSync(indexPath, '<!DOCTYPE html><html lang=\"zh-CN\"><head><meta charset=\"UTF-8\"><meta http-equiv=\"refresh\" content=\"0;url=产品/产品展示页.html\"></head><body><p>跳转中... <a href=\"产品/产品展示页.html\">点击进入商店</a></p></body></html>');
  ...
  console.log('');
  console.log('  📋 产品直达:');
  console.log('     https://' + GITEE_USER + '.gitee.io/' + REPO + '/开发工具箱.html');
  console.log('     https://' + GITEE_USER + '.gitee.io/' + REPO + '/产品/简历模板-极简风格.html');
  console.log('     https://' + GITEE_USER + '.gitee.io/' + REPO + '/产品/学习计划器-StudyPlanner.html');
  console.log('     https://' + GITEE_USER + '.gitee.io/' + REPO + '/产品/面试算法速查卡.html');
  console.log('');
}
