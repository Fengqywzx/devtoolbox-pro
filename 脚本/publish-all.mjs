...
const root = path.resolve(import.meta.url.replace('/脚本/publish-all.mjs','').replace('file:///',''));
...
async function main() {
  ...
  try {
    ...
    console.log('');
    console.log('  📋 你的产品链接:');
    console.log(`     工具箱: https://${GITEE_USERNAME}.gitee.io/${REPO_NAME}/开发工具箱.html`);
    console.log(`     简历模板: https://${GITEE_USERNAME}.gitee.io/${REPO_NAME}/产品/简历模板-极简风格.html`);
    console.log(`     学习计划: https://${GITEE_USERNAME}.gitee.io/${REPO_NAME}/产品/学习计划器-StudyPlanner.html`);
    console.log(`     算法速查: https://${GITEE_USERNAME}.gitee.io/${REPO_NAME}/产品/面试算法速查卡.html`);
    console.log('');
