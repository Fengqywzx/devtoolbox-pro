...
async function main() {
  try {
    ...
    fs.writeFileSync(path.join(root, '.gitignore'), [
      ...
      '备份/', '.buddy/', '笔记/',
      'orders.log', '脚本/think-daemon.mjs'
    ].join('\n'));
    ...
    console.log(`     🛠 工具箱:  ${pagesUrl}开发工具箱.html`);
    console.log(`     📄 简历:    ${pagesUrl}产品/简历模板-极简风格.html`);
    console.log(`     📚 计划器:  ${pagesUrl}产品/学习计划器-StudyPlanner.html`);
    console.log(`     ⚡ 速查卡:  ${pagesUrl}产品/面试算法速查卡.html`);
    console.log(`     🏪 商店页:  ${pagesUrl}产品/产品展示页.html`);
    console.log('');
